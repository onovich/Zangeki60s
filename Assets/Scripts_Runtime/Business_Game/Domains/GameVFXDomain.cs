...
namespace Zangeki {
    ...
    public static class GameVFXDomain {
        ...
        public static void VFX_PlayTapLeft(GameBusinessContext ctx, Vector2 pos) {
            ...
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_TapLeft", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlayTapRight(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_TapRight", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlayClangBreak1(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_ClangBreak1", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlayClangBreak2(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_ClangBreak2", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlayClangBreak3(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_ClangBreak3", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlaySwooshLeft(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_SwooshLeft", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlaySwooshRight(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_SwooshRight", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlaySwooshBreak2(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_SwooshBreak2", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlaySwooshBreak3(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_SwooshBreak3", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlaySlashLeft(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_SlashLeft", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlaySlashRight(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_SlashRight", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlayBlade1(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_Blade1", frames, false, frameInterval, pos, layer);
        }
        ...
        public static void VFX_PlayBlade2(GameBusinessContext ctx, Vector2 pos) {
            ...
            var frameInterval = table.intervalTime;
            var layer = SortingLayerConst.VFX;
            VFXFrameApp.AddVFXToWorld(ctx.vfxFrameContext, "VFX_Blade2", frames, false, frameInterval, pos, layer);
        }
